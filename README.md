...
My name is **Ming**, this is what my name looks like in Chinese: <img style="margin:0 4px 0 0" height="18px" width="18px" src="./assets/ming.png">.

- 🔭 I’m currently working on being Full-Stack Web Developer.
- 🐧 I’m a Linux fans, working on `Gentoo Linux` now.
- 💬 More to explore.
